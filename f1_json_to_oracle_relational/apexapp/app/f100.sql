...
prompt APPLICATION 100 - FORMULA1
--
-- Application Export:
--   Application:     100
--   Name:            FORMULA1
...
,p_name=>nvl(wwv_flow_application_install.get_application_name,'FORMULA1')
...
,p_attribute_01=>'AIzaSyCEn9vezbJYjVjVVsZp7x5BcVLyMiuWOZo'
);
end;
/
...
,p_name=>'Home'
,p_alias=>'HOME'
,p_step_title=>'FORMULA1'
,p_autocomplete_on_off=>'OFF'
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>'UHELLSTR'
,p_last_upd_yyyymmddhh24miss=>'20190629223222'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1465300789539055)
,p_plug_name=>'FORMULA1'
...
wwv_flow_api.create_page(
 p_id=>2
,p_user_interface_id=>wwv_flow_api.id(1453607254538942)
,p_name=>'Formula1 Historic Tracks'
,p_step_title=>'Formula1 Historic Tracks'
,p_autocomplete_on_off=>'OFF'
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>'UHELLSTR'
