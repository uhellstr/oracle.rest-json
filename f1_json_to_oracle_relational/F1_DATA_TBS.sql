...
CREATE TABLE F1_DATA_TRACK_IMAGES 
(
  CIRCUITID VARCHAR2(50 BYTE) NOT NULL 
, IMAGE BLOB 
, CONSTRAINT F1_DATA_TRACK_IMAGES_PK PRIMARY KEY 
  (
    CIRCUITID 
  )
  USING INDEX 
  (
      CREATE UNIQUE INDEX F1_DATA_TRACK_IMAGES_PK ON F1_DATA_TRACK_IMAGES (CIRCUITID ASC) 
      LOGGING 
      TABLESPACE USERS 
      PCTFREE 10 
      INITRANS 2 
...
NO INMEMORY 
NOPARALLEL 
LOB (IMAGE) STORE AS SYS_LOB0000084031C00002$$ 
( 
